...
if __name__ == "__main__":
    ...
    soundfont_path = "soundfonts/FluidR3_GM.sf2"  # piano
    absolute_fluidsynth_path = r"C:\Program Files\FluidSynth\fluidsynth-2.4.4-win10-x64\bin"  # CHANGE
    absolute_ffmpeg_path = r"C:\Program Files\ffmpeg\ffmpeg-2025-03-31-git-35c091f4b7-full_build\bin"  # CHANGE
